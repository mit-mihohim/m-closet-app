...
jQuery.fn.flexdatalist=function(e,t){
  ...
  var i=function(e,t){
    e.each(function(){
      ...
      a=i.flexdatalist,
      r=i.aliascontainer;
      r&&(e.removeClass("flexdatalist-set").attr({style:null,tabindex:null}).val(a&&a.originalValue&&!t?a.originalValue:"").removeData("flexdatalist").removeData("aliascontainer").off(),r.remove())
    })
  };
  ...
  return this.each(function(e){
    ...
    this.init=function(){
      ...
      this.set.up(),
      l.on("focusin",function(e){
        i.action.redoSearchFocus(e),
        i.action.showAllResults(e),
        o&&o.addClass("focus")}).on("input keydown",function(e){
        ...
        window.onresize=function(){i.position()},
        this.cache.gc(),
        e.selectionRequired&&i.fvalue.clear(!0,!0),
        this.fvalue._load(e.originalValue,function(){
          i.fdisabled(e.disabled),
          t.trigger("init:flexdatalist",[e])
        },!0
        )
    },
    this.action={keypressValue:function(e,t){
      var a=i.keyNum(e),
      r=l[0].value,
      n=i.options.get();
      ...
      keypressSearch:function(e){
        ...
        s=i.options.get();
        clearTimeout(a),
        (!t||13!==t&&(37>t||t>40))&&(a=setTimeout(function(){
          (0===s.minLength&&n>0||s.minLength>0&&n>=s.minLength)&&i.data.load(function(e){
            i.search.get(r,e,function(e){i.results.show(e)})})},
            s.searchDelay))
      },
      ...
      backSpaceKeyRemove:function(e){
        ...
        if(t.removeOnBackspace&&t.multiple){
          var a=l.val(),
          r=l.data("_remove");
          8===i.keyNum(e)&&(0===a.length?r?(i.fvalue.remove(r),
          l.data("_remove",null)):(console.log("remove!"),
          l.data("_remove",l.parents("li:eq(0)").prev())):l.data("_remove",null)
      )}},

      showAllResults:function(){
        var e=l.val();e=$.trim(e),
        ""===e&&0===i.options.get("minLength")&&i.data.load(function(e){
          i.results.show(e)
      })},
    ...
    this.set={up:function(){
      l=this.alias(),
      i.options.get("multiple")?o=this.multipleInput(l):l.insertAfter(t),
      t.attr("autofocus")&&l.focus(),
      t.data("aliascontainer",o?o:l).addClass("flexdatalist flexdatalist-set").css({position:"absolute",top:-14e3,left:-14e3}).attr("tabindex",-1);
      var e=t.attr("id"),a=l.attr("id");
      $('label[for="'+e+'"]').attr("for",a),
      this.chained()
    },
    alias:function(){
      var e=t.attr("id")?t.attr("id")+"-flexdatalist":s,i=$('<input type="text">').attr({"class":t.attr("class"),
      name:t.attr("name")?"flexdatalist-"+t.attr("name"):null,
      id:e,placeholder:t.attr("placeholder")}).addClass("flexdatalist-alias "+e).removeClass("flexdatalist").attr("autocomplete","off");return i
    },
    multipleInput:function(e){
      return o=$('<ul tabindex="1">').addClass("flexdatalist-multiple "+s).css({"border-color":t.css("border-left-color"),
      "border-width":t.css("border-left-width"),
      "border-style":t.css("border-left-style"),
      "border-radius":t.css("border-top-left-radius"),
      "background-color":t.css("background-color")}).insertAfter(t).click(function(){
    ...
    chained:function(){
      ...
      if(e.relatives&&e.chainedRelatives){
        ...
        e.relatives.on("change",function(){t()}),
        t(!0)
      }
    }
  },
  this.fvalue={get:function(e){
    var t=i.value,
    a=i.options.get();
    return!a.multiple&&!this.isJSON()||e?t:this.toObj(t)},
    set:function(e,a){
      return i.fdisabled()||(a||this.clear(!0),this._load(e)),
      t
    },
    add:function(e){
      return i.options.get("multiple")&&this.set(e,!0),
      this
    },
    toggle:function(e){
    ...
    remove:function(e){
      if(!i.fdisabled()){
        e=this.toObj(e),
        t.trigger("before:flexdatalist.remove",[e]);
        var a=[];
    ...
    _load:function(e,t,a){
      ...
      s=this.toStr(e),
      l=this.get(!0);
      return t=t?t:$.noop,0==s.length&&0==l.length?void t(e):(e=this.toObj(e),
      i.isEmpty(e)||i.isEmpty(n)||"*"===n?(t(e),
      void i.fvalue.extract(e,a)):(i.isObject(n)||(n=n.split(",")),
      void i.data.load(function(a){
        i.isObject(e)?$.isArray(e)||(e=[e]):e=e.split(",");
        for(var r=[],s=0;s<e.length;s++)for(var l=e[s],o=0;o<a.length;o++)for(var u=a[o],f=0;f<n.length;f++){
          var c=n[f],
          l=i.isDefined(l,c)?l[c]:l;
          i.isDefined(u,c)&&l===u[c]&&r.push(u)}r.length>0&&i.fvalue.extract(r,!0),
          t(e)
      },e)))
    },
    extract:function(e,a){
      ...
      a||t.trigger("after:flexdatalist.value",[n,r]).trigger("change:flexdatalist",[n,r]).trigger("change")},
      _extract:function(e){
        var t=this.text(e),
        a=this.value(e),
      ...
      single:function(e,t){
        ...
        toggle:function(e){
          ...
          if(a.toggleSelected){
            ...
            if(r){
              ...
              o=i.fvalue.toStr(o),
              i.value=o,
              t.trigger("after:flexdatalist.toggle",u).trigger("change:flexdatalist",u).trigger("change")
            }
          }
        },
        remove:function(e){
        ...
        li:function(e,t){
          ...
          return $("<li>").addClass("value"+(i.options.get("toggleSelected")?" toggle":"")).append(
            '<span class="text">'+t+"</span>"
            ).append(
              '<span class="fdl-remove">&times;</span>'
              ).data({text:t,value:i.fvalue.toObj(e)}).insertBefore(a)
        },
        checkLimit:function(){
        ...
        text:function(e){
          var t=e,a=i.options.get();
          return i.isObject(e)&&(t=e[a.searchIn[0]],t=i.isDefined(e,a.textProperty)?e[a.textProperty]:this.placeholders.replace(e,a.textProperty,t)),
          $("<div>").html(t).text()
        },
        placeholders:{
          ...
          parse:function(e){
            var t=e.match(/\{.+?\}/g);
            if(t){var i={};
            return t.map(function(e){i[e]=e.slice(1,-1)}),
            i}
            return!1
          }
        },
        clear:function(e,a){
          var r=i.value,
          s=i.options.get();
          return s.multiple&&this.multiple.removeAll(),
          i.value="",
          ""===r||a||t.trigger("change:flexdatalist",
          [{value:"",text:""},s]).trigger("change"),
          e&&(l[0].value=""),
          n=[],
          this
        },
        ...
        toStr:function(e){
          ...
          e&&(i.isEmpty(e)||!i.isDefined(e)?e="":"number"==typeof e?e=e.toString():this.isCSV()?e=e.join(i.options.get("valuesSeparator"))
  ...
  this.data={load:function(e,i){
    ...
    this.url(function(i){
      ...
      a["static"](function(i){
        ...
        a.datalist(function(i){
          r=r.concat(i),t.trigger("after:flexdatalist.data",[r]),
          e(r)
        })
      })
    },
    ...
    "static":function(e){
      ...
      if("string"==typeof t.data){
        ...
        this.remote({
          ...
          success:function(r){
            t.data=r,e(r),
            i.cache.write(a,r,t.cacheLifetime,!0)
          }
        })
      }else
    ...
    url:function(e,t){
      ...
      delete u.relatives);
      var f=i.cache.keyGen({relative:o,load:t,keyword:a,contain:r.searchContain},r.url),
      c=i.cache.read(f,!0);
      if(c)
      return void e(c);
      var d=$.extend(o,r.params, {load:t,contain:r.searchContain,selected:s,original:r.originalValue,options:u});
      d[n]=a,
      this.remote({
        url:r.url,
        data:d,
    ...
    remote:function(e){
      var a=this,
      r=i.options.get();
      t.hasClass("flexdatalist-loading")||(t.addClass("flexdatalist-loading"),
        "json"===r.requestContentType&&(e.data=JSON.stringify(e.data)),
        $.ajax(
          $.extend({
            type:r.requestType,
            dataType:"json",
    ...
    get:function(e,a,r){
      ...
      if(t.length>0)for(var l=0;l<s.length;l++){
        ...
        if(i.isDefined(e,o)&&e[o]){
          for(var u=e[o].toString(),f=u,c=this.split(u),d=0;d<t.length;d++){
            var h=t[d];
            this.find(h,c)&&(r.push(h),
              f=this.highlight(h,f)
            )
      ...
      return t?t.replace(
        new RegExp(e,i.options.get("searchContain")?"ig":"i"),"|:|$&|::|"):(e=e.split("|:|").join('<span class="highlight">'),e.split("|::|").join("</span>"))
    },find:function(e,t){
      for(var a=i.options.get(),r=0;r<t.length;r++)
      {
        var n=t[r];
        if(n=this.normalizeString(n),e=this.normalizeString(e),a.searchEqual)
        return n==e;
      ...
      for(var t=0;t<e.length;t++){var a=$.trim(e[t]);if(a.indexOf(" ")>0){var r=a.split(" ");$.merge(e,r)}}
      return e
    },normalizeString:function(e){
      if("string"==typeof e){var t=i.options.get("normalizeString");return"function"==typeof t&&(e=t(e)),e.toUpperCase()}
      return e
    }
  },this.results={show:function(e){
    var a=this,r=i.options.get();
    if(this.remove(!0),e){
      if(0===e.length)
      return void this.empty(r.noResultsText);
      var n=this.container();
      r.groupBy?(e=this.group(e),Object.keys(e).forEach(function(t){
        var s=e[t],l=r.groupBy,o=i.results.highlight(s[0],l,t);
    ...
    if(!i.isEmpty(e)){var t=this.container(),a=l.val();e=e.split("{keyword}").join(a),$("<li>").addClass("item no-results").append(e).appendTo(t)}
  },items:function(e,a){
    var r=i.options.get("maxShownResults");
    t.trigger("show:flexdatalist.results",[e]);
    for(var n=0;n<e.length&&!(r>0&&r===n);n++)this.item(e[n]).appendTo(a);t.trigger("shown:flexdatalist.results",[e])
  },item:function(e){
    for(var t=$("<li>").data("item",e).addClass("item"),a=i.options.get(),r=a.visibleProperties,n=0;n<r.length;n++){
      ...
      if(s.indexOf("{")>-1){
        ...
        else{var f=i.results.highlight(e,s);u=$("<span>").addClass("item item-"+s).html(f+" ")}
      }u.appendTo(t)
    }return t
  },container:function(){
    var e=t;o&&(e=o);
    ...
    for(var t=[],a=i.options.get("groupBy"),r=0;r<e.length;r++){var n=e[r];
      if(i.isDefined(n,a)){var s=n[a];i.isDefined(t,s)||(t[s]=[]),t[s].push(n)}
    }return t
  ...
  },this.cache={write:function(e,t,a,r){
    ...
    if(i.cache.isSupported())for(var e in localStorage)if(e.indexOf(s)>-1||e.indexOf("global")>-1){
    ...
    {multiple:null===r.multiple?t.is("[multiple]"):r.multiple,disabled:null===r.disabled?t.is("[disabled]"):r.disabled,originalValue:i.value});
    return this.set(e),e
  },get:function(e){
    ...
    if(e.searchIn=i.csvToArray(e.searchIn),
    e.relatives=e.relatives&&$(e.relatives).length>0?$(e.relatives):null,
    e.textProperty=null===e.textProperty?e.searchIn[0]:e.textProperty,
    e.visibleProperties=i.csvToArray(e.visibleProperties,e.searchIn),
    ...
    return e.which||e.keyCode},this.isEmpty=function(e){
  ...
  t.data("flexdatalist")||e(document).mouseup(function(t){
    ...
    s=a.length,
    l=t.which||t.keyCode;
    if(0!==s){if(27===l)return void i.remove();
      if(13===l)t.preventDefault(),
      r.click();
      else if(40===l||38===l){
        t.preventDefault(),
        40===l?r=s>n&&r.nextAll(".item").first().length>0?r.removeClass("active").nextAll(".item").first().addClass("active")
        :a.removeClass("active").filter(".item:first").addClass("active")
        :38===l&&(r=n>0&&r.prevAll(".item").first().length>0?r.removeClass("active").prevAll(".item").first().addClass("active"):a.removeClass("active").filter(".item:last").addClass("active")),
        r.trigger("active:flexdatalist.results",[r.data("item")]);
        var o=(0===r.prev().length?r:r.prev()).position().top;i.animate({scrollTop:o+i.scrollTop()},100)
      }
    }
  }).data("flexdatalist",!0),
